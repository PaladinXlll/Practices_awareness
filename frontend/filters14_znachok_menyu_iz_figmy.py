...
class FilterIconWidget(QWidget):
    """Иконка фильтра из изображения"""
    def __init__(self, size=22, parent=None):
        ...
        base_dir = os.path.dirname(os.path.abspath(__file__))
        icon_path = os.path.join(base_dir, "filter_icon.png")
...
class CalendarGoldFilterWidget(QWidget):
    ...
    def _create_header(self):
        ...
        # Иконка фильтра из изображения (слева)
        filter_icon = FilterIconWidget(size=22)
